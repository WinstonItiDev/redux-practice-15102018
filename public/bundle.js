...
function fetchCats() {
    return function (dispatch) {
        _superagent2.default.get('/api/data').then(function (res) {
            return res.body;
        }).then(function (cats) {
...
function addCat(formInput) {
    return function (dispatch) {
        _superagent2.default.post('/api/data').send(formInput).end(function (err, res) {
            if (err) {
...
module.exports = {
    receiveCats: receiveCats,
    fetchCats: fetchCats,
    addCat: addCat,
    addCatAction: addCatAction
...
var _Header = __webpack_require__(/*! ./Header.jsx */ "./client/components/Header.jsx");

var _Header2 = _interopRequireDefault(_Header);

var _PostForm = __webpack_require__(/*! ./PostForm.jsx */ "./client/components/PostForm.jsx");

var _PostForm2 = _interopRequireDefault(_PostForm);

var _Posts = __webpack_require__(/*! ./Posts.jsx */ "./client/components/Posts.jsx");
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            "h1",
            null,
            "Redux Practice Exercise 17/10/2018"
          )
        )
      );
    }
  ...
  _createClass(Posts, [{
    ...
    value: function componentWillMount() {
      ...
      fetch('https://jsonplaceholder.typicode.com/posts').then(function (res) {
        ...
        return _this2.setState({ posts: data });
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var postItems = this.state.posts.map(function (post) {
        return _react2.default.createElement(
          'div',
          { key: post.id },
          _react2.default.createElement(
...
var _cats = __webpack_require__(/*! ./cats */ "./client/reducers/cats.js");
